package com.goffayoh.config;

import org.hibernate.dialect.Dialect
import org.hibernate.dialect.identity.IdentityColumnSupport
import java.sql.Types
import SQLiteIdentityColumnSupport
...
class SQLiteDialect : Dialect() {
  ...
  override fun getAddForeignKeyConstraintString(
    constraintName: String, foreignKey: Array<String>, referencedTable: String, primaryKey: Array<String> , referencesPrimaryKey: Boolean
    ): String {
    return "";
  }
